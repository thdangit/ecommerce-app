...
const DetailProductInCart = () => {
  ...
  const deletes = (id) => {
    dispatch(DELETE(id));
    history.push("/");
    toast.warning("Dalete Cart Successful!");
  };
  ...
  const increment = (e) => {
    dispatch(ADD(e));
    toast("Update Cart Successful!");
  };

  // descriment item
  const decrement = (item) => {
    dispatch(REMOVE_INT(item));
    toast("Remove Cart Successful!");
  };
...
export default DetailProductInCart;
